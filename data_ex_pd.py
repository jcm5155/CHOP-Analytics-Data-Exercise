...
encounters.drop(encounters[encounters.REASONCODE !=
                           55680006].index, inplace=True)
...
enc_grouped = encounters.groupby(
    'PATIENT_ID')['ENCOUNTER_ID'].apply(lambda x: x.values)
